...
export default {
  components: { baseButton },
	mounted() {
		...
		const marqueeElemDisplayed = getComputedStyle(root).getPropertyValue('--marquee-elem-displayed');
...
:root{
	...
	--marquee-elem-width: calc(var(--marquee-width)/var(--marquee-elem-displayed));
}
...
@keyframes scrolling{
	...
	100%{
		transform: translateX(calc(-1*var(--marquee-elem-width)*var(--marquee-elem)));
	}
}
